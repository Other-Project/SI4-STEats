...
public class SingleOrderManager extends AbstractManager<SingleOrder> {
    ...
    public void demo() {
        ...
        // TODO : Modify the mocked values to apply the discounts
        List.of(
                new SingleOrder("1", albanFalcoz, null,
                        ...
                        prices.get(itemsR1[1]), prices.get(itemsR1[1]),
                ...
                new SingleOrder("3", albanFalcoz, null,
                        ...
                        prices.get(itemsR1[1]) * 2 + prices.get(itemsR1[0]), prices.get(itemsR1[1]) * 2 + prices.get(itemsR1[0]),
                ...
                new SingleOrder("5", albanFalcoz, "1",
                        ...
                        prices.get(itemsR1[0]) * 2 + prices.get(itemsR1[1]) * 3, prices.get(itemsR1[0]) * 2 + prices.get(itemsR1[1]) * 3,
                        eurecom, "1", Status.DELIVERED),
                new SingleOrder("6", janeDoe, "1",
                        ...
                        prices.get(itemsR1[1]) * 8 + prices.get(itemsR1[0]), prices.get(itemsR1[1]) * 8 + prices.get(itemsR1[0]),
                        eurecom, "1", Status.DELIVERED),
                ...
                new SingleOrder("9", albanFalcoz, null,
                        ...
                        prices.get(itemsR1[1]) * 9 + prices.get(itemsR1[0]) * 2, prices.get(itemsR1[1]) * 9 + prices.get(itemsR1[0]) * 2,
                ...
                new SingleOrder("10", johnDoe, "3",
                        ...
                        Map.of(itemsR2[0], 10), Map.of(itemsR2[0], 10),
                ...
                new SingleOrder("11", janeDoe, null,
                        ...
                        prices.get(itemsR1[0]), prices.get(itemsR1[0]),
                        eurecom, "1", Status.PAID),
                new SingleOrder("12", janeDoe, "3",
                        LocalDateTime.of(today, LocalTime.of(21, 46)), LocalDateTime.of(today, LocalTime.of(19, 26)),
                        Map.of(itemsR2[0], 1), Map.of(itemsR2[0], 1),
                        prices.get(itemsR2[0]), prices.get(itemsR2[0]),
                        inria, "2", Status.INITIALISED),
